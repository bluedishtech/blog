...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		credit: {
			...
			text: "Image from 5s9 Gallery", // Credit text to be displayed
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://bluedishtech.github.io/", // Internal links should not include the base path, as it is automatically added
